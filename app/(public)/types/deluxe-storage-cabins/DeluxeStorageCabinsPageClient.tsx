...
/**
 * DeluxeStorageCabins Page Client - Ported to Next.js Client Component
...
import { deluxeStorageCabinsDefaults, DeluxeStorageCabinsContent, ModelItem, QuickNavItem } from '@/data/defaults/deluxeStorageCabinsDefaults';

export default function DeluxeStorageCabinsPageClient({ initialContent }: { initialContent: any }) {
  useEffect(() => {
  ...
  return (
    <EditablePageWrapper<DeluxeStorageCabinsContent>
      slug="deluxe-storage-cabins"
      defaultContent={deluxeStorageCabinsDefaults}
    >
