...
import { ourModelsDefaults, OurModelsContent, CategoryItem, ModelItem } from '@/data/defaults/ourModelsDefaults';

export default function OurModelsPageClient({ initialContent }: { initialContent: any }) {
  return (
