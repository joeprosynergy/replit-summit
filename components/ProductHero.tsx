...
const ProductHero = ({
  ...
  const resolveBackPath = (): BackPathConfig => {
    // If backPath has path/label directly (already resolved by useBackPath), use it
    ...
    // Check if user came from a styles page (via referrer or current path)
    if (cameFromStyles) {
