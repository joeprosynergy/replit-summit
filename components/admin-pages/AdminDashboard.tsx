...
function getKeySource(): string {
  if (process.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_DEFAULT_KEY) return 'DEFAULT_KEY';
  if (process.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY) return 'PUBLISHABLE_KEY';
  return 'None';
}
        ...
        <div className="space-y-8">
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                  ...
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/about-us')}>
                    About Us
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/contact-us')}>
                    Contact Us
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/buyers-guide')}>
                    Buyer's Guide
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/gallery')}>
                    Gallery
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/financing')}>
                    Financing
                  </Button>
              ...
              <div>
                ...
                <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/styles')}>
                    Styles Overview
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/styles/utility')}>
                    Utility Style
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/styles/barn')}>
                    Barn Style
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/styles/modern')}>
                    Modern Style
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/styles/greenhouse')}>
                    Greenhouse (Style)
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/styles/animal-shelters')}>
              ...
              <div>
                ...
                <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types')}>
                    Types Overview
                  </Button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/basic-storage')}>
                    Basic Storage Overview
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/basic-storage/economy-shed')}>
                    Economy Shed
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/basic-storage/budget-pro-utility')}>
                    Budget Pro - Utility
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/basic-storage/budget-pro-lofted-barn')}>
              ...
              <div>
                ...
                <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/deluxe-storage-cabins')}>
                    Deluxe Storage Overview
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/deluxe-storage-cabins/pro-utility-shed')}>
                    Pro - Utility Shed
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/deluxe-storage-cabins/pro-lofted-barn')}>
                    Pro - Lofted Barn
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/deluxe-storage-cabins/cabin')}>
                    Summit Cabin
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/deluxe-storage-cabins/barn-cabin')}>
                    Barn Cabin
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/deluxe-storage-cabins/modern-shed')}>
                    Modern Shed
                  </Button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/garages-carports')}>
                    Garages & Carports Overview
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/garages-carports/garage')}>
                    Garage
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/garages-carports/carports')}>
                    Carports
                  </Button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/greenhouse')}>
                    Greenhouse
                  </Button>
                  <Button variant="outline" className="justify-start" onClick={() => router.push('/types/animal-shelters')}>
                    Animal Shelters
                  </Button>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
                <Button variant="outline" className="justify-start" onClick={() => router.push('/admin/global-colors')}>
                  Global Color Palette
                </Button>
                <Button variant="outline" className="justify-start" onClick={() => router.push('/admin/code-snippets')}>
                  Code Snippets
                </Button>
                <Button variant="outline" className="justify-start" onClick={() => router.push('/cloudinary-upload')}>
                  Cloudinary Upload
                </Button>
                <Button variant="outline" className="justify-start" onClick={() => router.push('/asset-audit')}>
                  Asset Audit
                </Button>
              </div>
            </CardContent>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              ...
              <CardContent>
                <Button variant="secondary" className="w-full" onClick={() => router.push('/admin/users')}>
                  Manage Users
                </Button>
              </CardContent>
            </Card>
