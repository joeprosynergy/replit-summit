...
import { homeDefaults, HomeContent } from './defaults/homeDefaults';
  ...
  return (
    ...
    >
      {({ content: editableContent, isEditMode, updateField }) => (
        <>
          <Helmet>
            <title>{editableContent.metaTitle}</title>
            <meta name="description" content={editableContent.metaDescription} />
            <meta property="og:title" content={editableContent.metaTitle} />
            <meta property="og:description" content={editableContent.metaDescription} />
            <meta name="twitter:title" content={editableContent.metaTitle} />
            <meta name="twitter:description" content={editableContent.metaDescription} />
          </Helmet>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      ...
                      >
                        {editableContent.locationsSecondaryButtonOpenInNewTab ? (
                          ...
                          <Link to={editableContent.locationsSecondaryButtonLink}>
                            <Button variant="heroOutline" size="lg">
                              {editableContent.locationsSecondaryButton}
                            </Button>
                          </Link>
