...
export default function BlockChart() {
  return (
    <>
      <Helmet>
        <title>Block Chart & Site Prep Guide | Summit Portable Buildings</title>
        <meta name="description" content="Complete guide to concrete block requirements, runner spacing, building heights, and site preparation for Summit Portable Buildings delivery." />
        <link rel="canonical" href="https://summitbuildings.com/block-chart" />
