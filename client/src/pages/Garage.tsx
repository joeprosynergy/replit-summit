...
export const defaultContent: GarageContent = {
  ...
  galleryImage1: cloudinaryImages.garage1,
  galleryImage1Alt: 'Summit Garage - Red with white trim',
  galleryImage2: cloudinaryImages.garage2,
  galleryImage2Alt: 'Summit Garage - Gray metal exterior',
  galleryImage3: cloudinaryImages.garage3,
  galleryImage3Alt: 'Summit Garage - Tan with brown trim',
  galleryImage4: cloudinaryImages.garage4,
  galleryImage4Alt: 'Summit Garage - White with garage door',
  ...
  feature1: '9\'x7\' Insulated Overhead Door',
  feature2: 'T-handle Lock/Key',
  feature3: '36" Solid Steel Walk-in Door',
  feature4: '1 – 2\'x3\' Window',
  feature5: '7\' 9" Walls',
  feature6: 'Floor Joists Spaced 12" on Center',
  feature7: 'Built to Handle Vehicle Weight',
  feature8: 'Ramps Available',
  ...
  use1: 'Vehicle Storage',
  use2: 'Small Tractor Storage',
  use3: 'Hail Protection',
  use4: 'Mower & Equipment Storage',
  use5: 'Power Tools & Workshop',
  use6: 'Woodworking Shop',
  use7: 'Extra Project Space',
  use8: 'Motorcycle Storage',
  use9: 'ATV & UTV Storage',
