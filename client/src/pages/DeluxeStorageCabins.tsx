/**
 * DeluxeStorageCabins Page - Refactored for CMS-First Architecture
...
import { deluxeStorageCabinsDefaults, DeluxeStorageCabinsContent, ModelItem, QuickNavItem } from './defaults/deluxeStorageCabinsDefaults';
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    {isEditMode ? (
                      ...
                      <>
                        ...
                        <Link
                          to={content.ctaSecondaryButtonLink}
