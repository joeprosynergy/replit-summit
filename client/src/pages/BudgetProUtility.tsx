...
const defaultContent: BudgetProUtilityContent = {
  ...
  galleryImage1: cloudinaryImages.budgetProUtility,
  galleryImage1Alt: 'Budget Pro Utility - Gray with red trim',
  galleryImage2: cloudinaryImages.budgetProUtility2,
  galleryImage2Alt: 'Budget Pro Utility - White with black trim',
  galleryImage3: cloudinaryImages.budgetProUtility3,
  galleryImage3Alt: 'Budget Pro Utility - Gray with red trim rear view',
  ...
  feature2: '5/8" Subfloor',
  feature3: '7\'9" (93") Wall Height',
  feature4: '24" O.C. Wall Studs',
  feature5: '48" O.C. Rafters w/ 2x4 Lathing',
  feature6: 'Side or Front Door Entry Options',
  feature7: 'Additional Doors & Windows Available',
  feature8: 'Customizable Layout for Any Use',
