/**
 * BasicStorage Page - Refactored for CMS-First Architecture
...
import { basicStorageDefaults, BasicStorageContent, ModelItem, QuickNavItem } from './defaults/basicStorageDefaults';
