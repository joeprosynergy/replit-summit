...
const BasicStorage = () => {
  ...
  const { showDuplicateDialog, showDeleteDialog, newSlug, isDuplicating, isDeleting, setNewSlug, setShowDuplicateDialog, setShowDeleteDialog, duplicatePage, deletePage } = usePageManagement('basic-storage');
  ...
  const {
    ...
    reset: resetPage,
    startEditing,
  } = useEditablePageContent('basic-storage', defaultContent);
  ...
  const {
    ...
    save: saveModels,
    reset: resetModels,
  } = useSectionContent('basic-storage', 'models', defaultModels as any) as {
    content: ModelsContent;
  ...
  const {
    ...
    save: saveQuickNav,
    reset: resetQuickNav,
  } = useSectionContent('basic-storage', 'quick-nav', defaultQuickNav as any) as {
    content: QuickNavContent;
  ...
  const {
    ...
    save: saveCta,
    reset: resetCta,
  } = useSectionContent('basic-storage', 'cta', defaultCta as any) as {
    content: CtaContent;
