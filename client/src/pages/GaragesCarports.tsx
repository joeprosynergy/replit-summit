/**
 * GaragesCarports Page - Refactored for CMS-First Architecture
...
import { garagesCarportsDefaults, GaragesCarportsContent, ModelItem, QuickNavItem } from './defaults/garagesCarportsDefaults';
