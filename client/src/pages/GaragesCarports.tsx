...
const GaragesCarports = () => {
  ...
  const {
    ...
    reset: resetPage,
    startEditing,
  } = useEditablePageContent('garages-carports', defaultContent);
  ...
  const {
    ...
    save: saveModels,
    reset: resetModels,
  } = useSectionContent('garages-carports', 'models', defaultModels as any) as {
    content: ModelsContent;
  ...
  const {
    ...
    save: saveQuickNav,
    reset: resetQuickNav,
  } = useSectionContent('garages-carports', 'quick-nav', defaultQuickNav as any) as {
    content: QuickNavContent;
  ...
  const {
    ...
    save: saveCta,
    reset: resetCta,
  } = useSectionContent('garages-carports', 'cta', defaultCta as any) as {
    content: CtaContent;
