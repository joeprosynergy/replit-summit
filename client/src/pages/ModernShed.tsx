    ...
    <EditablePageWrapper slug="modern-shed" defaultContent={defaultContent}>
      {({ content, isEditMode, updateField }) => {
        const galleryImages = [
          ...
          { src: content.galleryImage7 as string, alt: content.galleryImage7Alt as string },
          { src: content.galleryImage8 as string, alt: content.galleryImage8Alt as string },
          { src: content.galleryImage9 as string, alt: content.galleryImage9Alt as string },
          { src: content.galleryImage10 as string, alt: content.galleryImage10Alt as string },
        ];
