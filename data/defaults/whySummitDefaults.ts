...
export const whySummitDefaults: WhySummitContent = {
  ...
  styles: [
    ...
    {
      name: 'Cabin',
      startingPrice: 'Starting at $29,717',
      description: 'Finished interior shell for home offices, she-sheds, man caves, or guest quarters. Includes electrical package, double pane windows, and treated wood porch.',
